                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-news-table-toolbar="base">
                            ...
                            <a class="btn btn-primary btn-sm me-2 mb-2" data-bs-toggle="modal" data-bs-target="#kt_modal_add_news" onClick="clearForm()"><i class="fa fa-plus"></i>Tambah Berita</a>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function clearForm(){
        document.getElementById("head_title").textContent = "Tambah Berita";
        $('#myForm')[0].reset();
    ...
    // Get Data
    function getData(id){
        document.getElementById("head_title").textContent = "Ubah Berita";
