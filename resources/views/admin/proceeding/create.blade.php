...
<div class="modal fade" id="kt_modal_add_proceeding" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_proceeding_header">
            ...
            <form id="myForm" action="{{ url('/'.Request::segment(1)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    {{ csrf_field() }}
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_proceeding_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_proceeding_header" data-kt-scroll-wrappers="#kt_modal_add_proceeding_scroll" data-kt-scroll-offset="800px">
                        
                        <input type="hidden" class="form-control" id="id_proceeding"/>
                        ...
                        <div class="fv-row mb-7">
                            <label class="fw-bold fs-6 mb-2">{{ __('ISSN') }}</label>
                            <input type="text" class="form-control" placeholder="ISSN" name="issn" id="issn" />
                            <div id="issn-error" class="fv-plugins-message-container invalid-feedback"></div>
                        </div>

                        <div class="fv-row mb-7">
                            <label class="fw-bold fs-6 mb-2">{{ __('DOI') }}</label>
                            <input type="text" class="form-control" placeholder="DOI" name="doi" id="doi" />
                            <div id="doi-error" class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
