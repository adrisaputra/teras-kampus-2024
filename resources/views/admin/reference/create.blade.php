...
<div class="modal fade" id="kt_modal_add_reference" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <div class="modal-content">
            <div class="modal-header" id="kt_modal_add_reference_header">
            ...
            <form id="myForm" action="{{ url('/'.Request::segment(1)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    {{ csrf_field() }}
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_reference_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_reference_header" data-kt-scroll-wrappers="#kt_modal_add_reference_scroll" data-kt-scroll-offset="800px">
                        
                        <input type="hidden" class="form-control" id="id_reference"/>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <select class="form-control" name="category" id="category">
                                ...
                                <option value="Teori Sosial">Teori Sosial</option>
                            </select>
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">{{ __('Deskripsi') }}</label>
