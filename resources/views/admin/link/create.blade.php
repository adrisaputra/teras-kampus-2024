            ...
            <form id="myForm" action="{{ url('/'.Request::segment(1)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_link_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_link_header" data-kt-scroll-wrappers="#kt_modal_add_link_scroll" data-kt-scroll-offset="300px">
                        ...
                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">{{ __('Nama Link') }}</label>
                            <input type="hidden" class="form-control" id="id_link"/>
                            <input type="text" class="form-control" placeholder="Nama Link" name="name" id="name" value="{{ old('name') }}" />
                            <div id="name-error" class="fv-plugins-message-container invalid-feedback"></div>
                        </div>

                        <div class="fv-row mb-7">
                            <label class="required fw-bold fs-6 mb-2">{{ __('Link') }}</label>
                            <input type="text" class="form-control" placeholder="Link" name="link" id="link" value="{{ old('link') }}" />
                            <div id="link-error" class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
