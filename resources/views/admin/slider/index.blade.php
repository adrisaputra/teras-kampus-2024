                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-slider-table-toolbar="base">
                            ...
                            <a class="btn btn-primary btn-sm me-2 mb-2" data-bs-toggle="modal" data-bs-target="#kt_modal_add_slider" onClick="clearForm()"><i class="fa fa-plus"></i>Tambah Slider</a>
                        </div>
                    </div>
                </div>
    ...
    function getData(id){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                var imageLink = '<br><a href="{{ asset("upload/slider/") }}/' + response.data.image + '" class="btn mb-2 mr-1 btn-sm btn-info snackbar-bg-info" target="_blank">Lihat Gambar Sebelumnya</a>';
