											...
											<div class="product col-md-4 col-sm-6 col-12"  data-animate="fadeInUp" data-delay="{{$i+1}}00">
												<div class="grid-inner">
													<div class="product-image h-translate-y all-ts">
														{{--<a href="{{ url('page-journal-detail/'.$v->id) }}"><img src="{{ asset('upload/journal/'.$v->cover) }}" alt="Image 1"></a>--}}
														<a href="{{ $v->url }}" target="_blank"><img src="{{ asset('upload/journal/'.$v->cover) }}" alt="Image 1"></a>
													</div>
