							...
							<div class="postcontent col-lg-12"  data-animate="fadeInUp" data-delay="200">
								...
								<div class="single-post mb-0">
									...
									<div class="entry clearfix">
										...
										<form method="POST" action="{{ url('web-register') }}" method="POST" enctype="multipart/form-data">
											@csrf
													
											@if ($message = Session::get('status'))
												<div class="col-md-8 offset-2 form-group" style="margin-bottom:10px">
										...
										<div class="row">
											...
											@if ($errors->has('name')) <b style="font-size:12px;color: #f44336;">{{ $errors->first('name') }}</b>@endif
											</div>
										</div>
										<div class="row" style="margin-top:-10px">
											...
											@if ($errors->has('email')) <b style="font-size:12px;color: #f44336;">{{ $errors->first('email') }}</b>@endif
											</div>
										</div>
										<div class="row" style="margin-top:-10px">
											<div class="col-md-3 offset-2 form-group">
											...
											@if ($errors->has('address')) <b style="font-size:12px;color: #f44336;">{{ $errors->first('address') }}</b>@endif
											</div>
										</div>
										<div class="row" style="margin-top:-10px">
											<div class="col-md-3 offset-2 form-group">
											...
											@if ($errors->has('phone')) <b style="font-size:12px;color: #f44336;">{{ $errors->first('phone') }}</b>@endif
											</div>
										</div>
										<div class="row" style="margin-top:-10px">
											<div class="col-md-3  offset-2  form-group">
											...
											@if ($errors->has('password')) <b style="font-size:12px;color: #f44336;">{{ $errors->first('password') }}</b>@endif
											</div>
										</div>
										<div class="row" style="margin-top:-10px">
											<div class="col-md-3  offset-2  form-group">
											...
											@if ($errors->has('password_confirmation')) <b style="font-size:12px;color: #f44336;">{{ $errors->first('password_confirmation') }}</b>@endif
											</div>
										</div>
										<br>
										<div class="text-center"><button type="submit" class="btn btn-success" style="background: #d41e10;
											...
											<br><br>
											Sudah Punya Akun ? Login <a href="{{ url('page-login') }}">Di Sini !</a>
											</div>
										</form>
