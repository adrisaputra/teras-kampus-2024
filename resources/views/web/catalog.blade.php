										...
										<div class="product col-md-4 col-sm-6 col-12">
											<div class="grid-inner">
												<div class="product-image h-translate-y all-ts">
													@if($title=="Buku Ajar")
														<a href="demo-articles-single.html"><img src="{{ asset('upload/textbook/'.$v->cover) }}" alt="Image 1"></a>
													@elseif($title=="Monograf")
														<a href="demo-articles-single.html"><img src="{{ asset('upload/monograph/'.$v->cover) }}" alt="Image 1"></a>
													@elseif($title=="Referensi")
														<a href="demo-articles-single.html"><img src="{{ asset('upload/reference/'.$v->cover) }}" alt="Image 1"></a>
													@else
														<a href="demo-articles-single.html"><img src="{{ asset('upload/novel/'.$v->cover) }}" alt="Image 1"></a>
													@endif
												</div>
