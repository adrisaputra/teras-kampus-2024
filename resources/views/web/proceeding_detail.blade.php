									...
									<div class="entry clearfix">
										...
										<div id="shop" class="shop row grid-container gutter-50" data-layout="fitRows">
											...
											<div class="product col-md-4 col-sm-6 col-12">
												<div class="grid-inner">
													<div class="product-image h-translate-y all-ts">
														<a href="demo-articles-single.html"><img src="{{ asset('upload/proceeding/'.$proceeding->cover) }}" alt="Image 1"></a>
													</div>
												</div>
											</div>
											...
											<div class="product col-md-4 col-sm-6 col-12">
												...
												<b>Judul : </b><br>
												{{ $proceeding->title }} <br><br>

												<b>Penulis : </b><br>
												{{ $proceeding->author }} <br><br>
												
												<b>ISSN : </b><br>
												{{ $proceeding->issn }} <br><br>
												
												<b>DOI : </b><br>
												{{ $proceeding->doi }} <br><br>
												
												<b>Tanggal Publikasi : </b><br>
												{{ date('d M Y', strtotime($proceeding->publication_date)) }} <br><br>
